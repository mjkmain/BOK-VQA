...
args = get_arguments()
version = f"GEL_{args.lang}_fold{args.fold}"
...
if __name__ == '__main__':
    ...
    for epoch in range(1, config.n_epoch+1):
        ...
        for idx, batch in iterator:
            ...
            with torch.no_grad():
                h_out, r_out, t_out = model(q_bert_ids, q_bert_mask, imgs, emb=0, get_gold=False) 
            ...
            gold_out, h_out, r_out, t_out = model(q_bert_ids, q_bert_mask, imgs, emb, get_gold=True) 
