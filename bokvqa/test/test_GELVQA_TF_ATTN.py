...
from bokvqa.vqa_datasets import GELVQATestDataset
...
for i in trange(len(test_dataset)):
    with torch.no_grad():
        ...
        #--
        h_out, r_out, t_out,_ = model(q_bert_ids.unsqueeze(0), q_bert_mask.unsqueeze(0), imgs.unsqueeze(0), emb=0, get_gold=False, bs=1)
        ...
        gold_out, h_out, r_out, t_out, _, emb_attn_output_weight = model(q_bert_ids.unsqueeze(0), q_bert_mask.unsqueeze(0), imgs.unsqueeze(0), emb, get_gold=True, bs=1)
